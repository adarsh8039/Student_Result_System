...
<html>
<head>
  <title>Admin | Class manage</title>
  <!-- head content  -->
    ...
    <div id="content">
      ...
      <div class="row">
                ...
                <tr>
                  ...
                  <td>
                    <a style="color:green; font-size:20px;" href="class-edit.php?ClassId=<?php echo $row['ClassId'] ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
